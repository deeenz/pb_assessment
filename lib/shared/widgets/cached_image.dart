...
class PokebookCacheImage extends StatelessWidget {
  final String imgUrl;
  final double? height;
  final double? width;
  final BoxFit boxFit;
...
class PokebookLottie extends StatelessWidget {
  final String url;
  final double? height, width;
  const PokebookLottie({Key? key, required this.url, this.height, this.width})
      : super(key: key);
